...
- [Impostazione iniziale](#impostazione-iniziale)
  - [SSH](#ssh)
  - [sudo](#sudo)
  - [Pacchetti utili](#pacchetti-utili)
  - [Gestione schermo](#gestione-schermo)
...
- [Altri strumenti](#altri-strumenti)
  ...
  - [Backup](#backup)
- [Copiare file sul server](#copiare-file-sul-server)
  - [scp](#scp)
  - [rsync](#rsync)
  - [sftp](#sftp)
- [Comandi interessanti](#comandi-interessanti)
  - [Ultimi pacchetti installati](#ultimi-pacchetti-installati)
  - [Temperatura del server](#temperatura-del-server)
- [Programmi utili](#programmi-utili)
- [openEMR](#openemr)
  - [Dipendenze](#dipendenze)
  - [Download e spostamento file](#download-e-spostamento-file)
  - [Upload database precedenti](#upload-database-precedenti)
